...
description: "3年後の売上の種を植えよう。全省庁統一資格申請から入札参加まで完全サポート。事前診断・全額返金保証付きで安心してチャレンジできます。月額44,000円で入札参加の全工程を行政書士がサポートいたします。"
---
...
<section class="testimonials-section" id="testimonials">
  <h2>実際に相談いただいたお客様の声</h2>
  <p class="testimonials-lead">全国からお問い合わせいただいています。実際に相談いただいたお客様の言葉をご紹介します。</p>
  ...
  <div class="testimonials-grid">
    ...
    <div class="testimonial-card">
      ...
      <blockquote class="testimonial-text">
        「3月より入札プロジェクトを発足しました。入札資格・実績はまだない状態ですが、全省庁統一資格の取得から丁寧にサポートしていただけると耲いました。今後の展開が楽しみです」
      </blockquote>
...
<div class="company-section">
  ...
  <p>📞 電話: 046-272-3357</p>
  <p>📧 メール: mail@flat-legal.com</p>
  <p>🏢 住所: 〒242-0006 神奈川県大和市南林間6丁目4番26号 1F</p>
  <p>⏰ 営業時間: 電話受付 平日9時～17時 / メール24時間受付</p>
</div>
