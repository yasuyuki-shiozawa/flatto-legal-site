---
layout: default
title: 入札用語集 | 公共調達の専門用語を分かりやすく解説
description: 入札・公共調達の専門用語辞典。一般競争入札、指名競争入札、総合評価落札方式、予定価格など入札関連用語を分かりやすく解説。初心者も安心して入札に参加できるようサポートします。
---

<!-- ページヘッダー -->
<section class="page-header">
    <div class="container">
        <h1 class="page-title">入札用語集</h1>
        <p class="page-subtitle">入札に関する専門用語を分かりやすく解説</p>
    </div>
</section>
